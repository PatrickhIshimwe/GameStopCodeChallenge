    ...
    return (
        <View style={styles.app}>
            ...
            <Text style={[styles.text, { fontWeight: "bold" }]}>
                Your job is to render an image of Pikachu and list 3 of his abilities.
            </Text>
            <Text style={styles.text}>
                You can either keep it simple, explain possible best practices when it
                comes to API integrations OR go berserk and implement all the bells and
                whistles!
            </Text>
        </View>
    );
